...
Comedian.create(first_name: "Robin", last_name: "Williams", age: 63, city: "Chicago")
Special.create(title: "HBO Comedy Hour", length: (53 * 60 + 30), comedian_id: 1, pic_url: "https://pmcvariety.files.wordpress.com/2018/01/18247-1-1100.jpg")
Special.create(title: "Comic Relief 5", length: (4 * 60 * 60), comedian_id: 1, pic_url: "https://images-na.ssl-images-amazon.com/images/I/21CQTGDA51L.jpg")
Special.create(title: "The Big Laff Off", length: (52 * 60), comedian_id: 1, pic_url: "https://images-na.ssl-images-amazon.com/images/I/51LAogZYHOL.jpg")
Special.create(title: "Comic Relief VII", length: (4 * 60 * 60), comedian_id: 1, pic_url: "https://images-na.ssl-images-amazon.com/images/I/412MDX0X85L.jpg")
...
# Comedian.create(first_name: "Steve", last_name: "Martin", age: "73", city: "4")
# Special.create(title: "", length: "", comedian_id: "", pic_url: )
# Special.create(title: "", length: "", comedian_id: "", pic_url: )
# Special.create(title: "", length: "", comedian_id: "", pic_url: )
# Special.create(title: "", length: "", comedian_id: "", pic_url: )
#
